...
function Allpackages() {
      ...
      <div className="border border-slate-300 rounded-xl bg-white shadow-2xl ">
        ...
        <div className="border-t p-7 py-7">
          <div
            ...
            type="primary"
          >
            <div className=" text-center ">Edit Package</div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="p-5">
      <Breadcums data={["Home", "Content", "Packages", "List Packages"]} />

      <div className="flex my-10">
        <div className="flex-none text-5xl font-bold bg ">Packages </div>
        <div className="flex-1"></div>
        <div className="flex">
          <button
            onClick={() => {
              route.push("/addpackage");
            }}
