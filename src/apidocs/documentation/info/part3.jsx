...
const jsondata = [
  {
    count: "integer",
    next: "http://backend-demo.revmd.co/api/v1/officeid/memberships/?limit=1&offset=2",
    previous:
      "http://backend-demo.revmd.co/api/v1/officeid/memberships/?limit=1",
    results: [
      {
        email: "string",
        first_name: "string",
...
const data = [
  ...
  },
  {
    key: "2",
    Parameters: "limit",
    Descripton: "Number of results to return per page.",
    ParameterType: "query",
    DataType: "	integer",
  },
  {
    key: "3",
    Parameters: "offset",
    Descripton: "The initial index from which to return the results.",
    ParameterType: "query",
    DataType: "	integer",
  },
];
          ...
          <Codebase>
            ...
            <Body className="fs-6 pb-3">
              ...
              <Highlight className="javascript">
                {`curl --location --request GET 'https://backend-demo.revmd.co/api/v1/1/memberships/' 
            ...
            <Base>
              ...
              <Code>
                ...
                /memberships/<Yellow>?limit=1&offset=1</Yellow>
              </Code>
            </Base>
            <Base>
            ...
            <Base className="py-0">
              <Codebase className="py-0">
                <Highlight className="json">
                  <pre style={{height:500}}>{JSON.stringify(jsondata, null, 2)}</pre>
                </Highlight>
              </Codebase>
            </Base>
          </div>
