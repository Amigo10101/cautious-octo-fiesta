        ...
        <Base>
          ...
          <Codebase>
            ...
            <Body className="fs-6 pb-3">
                ...
                {"/api/v1/{office_id}/memberships/{user_id}/"}
              </Body>
              
              <div className="mt-2">
                <Highlight language="javascript">
                  {`curl --location --request PUT 'https://backend-demo.revmd.co/api/v1/1/memberships/' \
        ...
        <TabPane tab="Curl" key="1">
          <div>
            <Base className="py-0">
              <>
                <Highlight language="javascript">
                  {`curl --location --request POST 'https://backend-demo.revmd.co/api/v1/1/memberships/' 
--header 'Content-Type: application/json' 
--header 'Accept: application/json' 
--header 'Authorization: Token Revmd_token' 
--data-raw '{
