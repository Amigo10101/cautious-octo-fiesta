            ...
            <Body className="fs-6 pb-3">
              ...
              <div className="mt-2">
                <Highlight language="javascript">
                  {`curl --location --request POST 'https://stage-api.revmd.website/api/v1/`+`${officeid}`+`/memberships/' \
        ...
        <TabPane tab="Curl" key="1">
          <div>
            <Base className="py-0">
              <>
                <Highlight language="javascript">
                  {`curl --location --request POST 'https://stage-api.revmd.website/api/v1/`+`${props.officeid}`+`/memberships/' 
--header 'Content-Type: application/json' 
--header 'Accept: application/json' 
--header 'Authorization: RevMDToken `+`${props.token}`+`' 
--data-raw '{
