        ...
        <Base>
          ...
          <Codebase>
            ...
            <Body className="fs-6 pb-3">
                <Tag className="fs-5 p-1" color="warning">
                  Put
                </Tag>
                {"/api/v1/"+`${officeid}`+"/memberships/{user_id}/"}
              </Body>
              
              <div className="mt-2">
                <Highlight language="javascript">
                  {`curl --location --request PUT 'https://backend-demo.revmd.co/api/v1/`+`${officeid}`+`/memberships/' \
        ...
        <TabPane tab="Curl" key="1">
          <div>
            <Base className="py-0">
              <>
                <Highlight language="javascript">
                  {`curl --location --request POST 'https://backend-demo.revmd.co/api/v1/`+`${officeid}`+`/memberships/' 
--header 'Content-Type: application/json' 
--header 'Accept: application/json' 
--header 'Authorization: RevMDToken ` +`${props.token}`+`' 
--data-raw '{
