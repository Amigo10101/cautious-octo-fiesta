...
const MemberTableoffice = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "office",
      render: (text) => {
        return <>{Id.mode === "O" ? Id.email : { text }}</>;
      },
    },
    {
      title: "Membership ID",
  ...
  const Updatemodal = () => {
    return (
      <>
        ...
        >
          <MainaddMember active={modaldata.membership.has_active_policy} />
        </Modal>
      </>
    );
  };
          ...
          <span className="float-end">
            <div className="row">
              ...
              <div className="col p-0">
                <a href="/dashboard/member/addmembers/step1">
                  <Button
...
export default MemberTableoffice;
